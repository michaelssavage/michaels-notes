...
import candles from "src/assets/images/blog/barry-lyndon-candles.png";
import barry from "src/assets/images/blog/redmond-barry.jpg";

<Picture src={barry} alt="Redmond barry" caption="Redmond Barry played by Ryan O'Neal" />
