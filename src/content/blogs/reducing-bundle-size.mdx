...
import rollup from "src/assets/images/blog/rollup-size.png";
import comparer from "src/assets/images/blog/bundle-comparer.png";
...
<Picture src={rollup} alt="Roll-up size" />
...
<Picture src={comparer} alt="comparing sizes of react-spring and framer-motion" />

After replacing framer-motion, the bundle size dropped a significant amount. The full rendered amount comes out at 1.14mb, and gzipped at 357kb. React-spring takes up less than 5% of the bundle size now. Although Framer-motion wasn't the biggest offender, it was good to get an additional reduction in size.