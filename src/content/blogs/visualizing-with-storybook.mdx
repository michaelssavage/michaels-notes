...
I wanted to deploy it as a subdomain at [storybook.michaelsavage.ie](http://michaelsavage.ie) but I scratched that plan in favour of a quicker outcome. Instead, I configured the site to serve Storybook at `/storybook` inside the main site deployment.
