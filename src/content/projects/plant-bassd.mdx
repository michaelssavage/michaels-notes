...
The site is created using <BlogLink link="https://nextjs.org/" text="Next.js" external /> (a React framework) and TypeScript. In it's early days the application was JavaScript-only, css styled, and the blogs were written in markdown. The site is constantly being refactored and I store a list of 'to-dos' on Trello.
...
<BlogLink link="/blog/what-is-plant-bassd" text="What is Plant Bass'd?" />
