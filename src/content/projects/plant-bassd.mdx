...
<Anchor link="https://plantbassd.com" text="Plantbassd.com" variant="link" />
was created using
<Anchor link="https://nextjs.org/" text="Next.js" variant="link" isExternal />
and TypeScript. In it's early days the app used JavaScript, CSS, and the blogs
were written in markdown. But the site was constantly being refactored and I
stored a list of 'to-dos' on Trello as I learned more about the technologies I
was using.
