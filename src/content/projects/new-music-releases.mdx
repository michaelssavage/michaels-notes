...
<Picture src="/project/nmr_tanstack.png" alt="tan stack apps" />
...
<Picture src="/project/playlist-updates.png" alt="Liked songs table" />

### Saved artists

The app displays a table of the users favourited artists from Spotify.

<Picture src="/project/saved-artists.png" alt="Liked songs table" />