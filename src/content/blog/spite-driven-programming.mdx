...
import programmer from "src/assets/images/blog/angry-programmer.png";

<Picture src={programmer} alt="angry programmer" caption="Image generated from Stable Diffusion" />

I was (am) a big fan of a music discovery application called <Anchor link="https://www.crabhands.com" text="crabhands" variant="link" />. It was an excellent mobile and web app built by a generous developer that used the Spotify API to notify users of new music releases. It was a great way for me to find new artists and songs that I wouldn't have come across otherwise.
...
Project details and link to Github: <Anchor text="New Music Releases" link="/projects/new-music-releases" variant="link" />  
Here's a link to the live demo: <Anchor link="https://new-music-releases-production.up.railway.app" variant="link" />