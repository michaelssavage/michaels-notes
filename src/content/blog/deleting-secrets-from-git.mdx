...
date: may 20, 2024
description: "Aaah I did it. I'm guilty. I accidentally committed sensitive data to Github. Oops. It was only for a personal project so nothing TOO drastic to worry about. How did I remove the commits and fix this issue?"
---
...
I used the <Anchor link="https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/removing-sensitive-data-from-a-repository" text="Github Docs" variant="blog" external /> to help me through the process. I'm working on Windows, so I used pip to install git-filter-repo:
