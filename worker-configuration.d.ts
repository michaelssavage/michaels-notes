/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 291cf093f37a087b57abcc97f1bc2ed9)
...
declare namespace Cloudflare {
	interface Env {
		...
		UPLOADCARE_SECRET: string;
		VITE_UPLOADCARE_KEY: string;
		VITE_PUBLIC_POSTHOG_KEY: string;
		CLOUDFLARE_API_TOKEN: string;
		SPANISH_API_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "SPOTIFY_REFRESH_TOKEN" | "LASTFM_API_KEY" | "WEATHER_API" | "ADMIN_SECRET" | "ADMIN_PASSWORD" | "UPLOADCARE_SECRET" | "VITE_UPLOADCARE_KEY" | "VITE_PUBLIC_POSTHOG_KEY" | "CLOUDFLARE_API_TOKEN" | "SPANISH_API_TOKEN">> {}
}
